 ...
 *  3. Keyboard shortcut blocking: PrtScn, Shift+PrtScn, Alt+PrtScn, Win+Shift+S, Ctrl+P, F12, Ctrl+Shift+I.
 *  4. beforeprint listener — hides content even if Ctrl+P isn't caught by keydown.
 *  5. Clipboard destruction — wipes copied screenshot data from system clipboard.
 *  6. Right-click contextmenu disabled.
 */
